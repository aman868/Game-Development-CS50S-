...
gSounds = {
    ['break1'] = love.audio.newSource('sounds/break1.wav','stream'),
    ['break2'] = love.audio.newSource('sounds/break2.wav','stream'),
    ['break3'] = love.audio.newSource('sounds/break3.mp3','stream'),
    ['break4'] = love.audio.newSource('sounds/break4.wav','stream'),
    ['break5'] = love.audio.newSource('sounds/break5.wav','stream'),
    ['bounce'] = love.audio.newSource('sounds/bounce.wav','stream'),
